...
Pod::Spec.new do |spec|
  ...
  spec.name         = "download"
  spec.version      = "0.0.2"
  spec.summary      = "A short description of download."
  ...
  spec.homepage     = "http://EXAMPLE/download"
  ...
  spec.source       = { :git => "https://github.com/zhuzhijia/TestPod.git", :tag => "#{spec.version}" }
